...
@EnableScheduling
@EnableSwagger2
@ComponentScan(basePackages = {"project001CommanPackage", "project001DomainPackage", "userInterfacePackage", "webAppPackage"})
@EntityScan(basePackages = {"project001CommanPackage", "project001DomainPackage", "userInterfacePackage", "webAppPackage"})
public class ShareProject01Application {
    ...
    public Docket productApi() {
        return new Docket(DocumentationType.SWAGGER_2).select()
                .apis(RequestHandlerSelectors.basePackage("webAppPackage")).build();
    }
